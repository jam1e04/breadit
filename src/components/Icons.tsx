...
export const Icons = {
  ...
  github: (props: LucideProps) => (
    <svg {...props} viewBox='0 0 24 24'>
      <path
        d='M12 2C6.48 2 2 6.48 2 12c0 4.42 2.87 8.17 6.84 9.5.5.08.68-.22.68-.48 0-.24-.01-.83-.01-1.49-2.78.6-3.37-1.34-3.37-1.34-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.6.07-.6 1.01.07 1.54 1.03 1.54 1.03.9 1.53 2.34 1.08 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.94 0-1.09.39-1.98 1.03-2.68-.1-.25-.45-1.29.1-2.64 0 0 .84-.27 2.75 1.02.79-.22 1.64-.33 2.49-.33.85 0 1.7.11 2.49.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.35.2 2.39.1 2.64.64.7 1.03 1.59 1.03 2.68 0 3.84-2.34 4.68-4.57 4.93.36.31.69.92.69 1.85 0 1.33-.01 2.41-.01 2.73 0 .26.18.56.69.48C19.14 20.16 22 16.42 22 12c0-5.52-4.48-10-10-10z'
        fill='currentColor'
      />
    </svg>
  )
